...
struct WorkoutView: View {
    ...
    private func repReadout(reps: Int, prescription: WorkoutPrescription, label: String, pace: Double?, learning: Bool = false, confirmedExercise: String? = nil) -> some View {
        VStack(alignment: .leading, spacing: 4) {
    ...
    private func aiNotes(_ set: WorkoutSetResult) -> some View {
        ...
        .task(id: "\(set.id)-\(aiCoachEnabled)-\(workout.automaticRecoveryProvisional)-\(workout.aiInputRevision)") {
